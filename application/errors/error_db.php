...
<title>Error</title>
	...
	#pleca-2{
		display: block;			
		height: 5px;		
		background: url('<?php echo base_url(); ?>images/css_sprite_lineas2.jpg') no-repeat;	
...
<body>
    ...
    <div id="main">
    	<img src="<?php echo base_url()."images/css_sprite_logotipocompleto.jpg"?>" class='img-logo' />
    	<div id="pleca-punteada"></div>
    	<div class="imagen-error">
    		<img src="<?php echo base_url()."images/css_prite_hojas2.png"?>" class='img-hojas'/>	
    	</div>    	    	
    	<div class="textos-error">
    		...
    		<div class="detalle-error">
				...
				<div class="titulo-proceso">
					<a href="<?php echo site_url() ?>">pagos.grupoexpansion.mx</a>	
				</div>
			</div>	
